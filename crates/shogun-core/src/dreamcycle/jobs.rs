...
fn payload_from_brief(
    ...
    BriefPayload {
        ...
        suggested_actions: brief
            ...
            .collect(),
        // The Charm line is generated by the MorningBrief job's Batch step (issue #10 M3), not
        // by this conversion — it stays None here and the job fills it after generation.
        charm_line: None,
    }
}
