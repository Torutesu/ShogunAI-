...
--   3. refinery_schema_history から version = 14 の行を削除する
-- 破壊的な列削除・改名は行っていないため、V13 のコードは V14 のスキーマ上でも動作する。

CREATE TABLE traceability_log_v14 (
...
INSERT INTO traceability_log_v14 (id, ts, route, purpose, destination, chunk_bytes, chunk_xxh64, third_party)
...
ALTER TABLE traceability_log_v14 RENAME TO traceability_log;
