...
export function CinematicSurface({ muted, onToggleMusic }: { muted: boolean; onToggleMusic: () => Promise<boolean> }): JSX.Element {
  return (
    <main className="onb-cinematic" data-testid="cinematic-surface">
      ...
      <MuteButton muted={muted} onToggle={onToggleMusic} />
    </main>
  );
}
