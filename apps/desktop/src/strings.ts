...
export const STRINGS = {
  en: {
    ...
    voiceEditModelHint: "Formats dictation after transcription. It never replaces your main AI key.",
    voiceEditKey: "Groq API key",
    voiceEditKeyHint: "Used only for fast dictation cleanup. Stored in Keychain on this Mac.",
    voiceEditKeyPresent: "Connected — cleanup is on.",
    voiceEditKeyAbsent: "Not set — dictation inserts the raw transcript.",
    voiceEditKeyPlaceholder: "Paste your Groq API key…",
    notchStatus: "Notch status",
    notchStatusShow: "Show",
    notchStatusHide: "Hide",
    notchStatusHint: "Show the current app and activity in the idle notch. Hide keeps the notch quiet until you hover.",
    ...
    memoryApiHint:
      "Let Cursor, Claude Desktop, and other local agents read and write your memory over MCP. Off by default — fail closed until you enable it.",
    memoryApiOn: "On",
    memoryApiOff: "Off",
    memoryApiGateNote:
      "Pro feature. Enable is the product gate until billing ships; trial counts as Pro.",
    memoryApiProfileLabel: "Profile (whoami)",
    memoryApiDisplayName: "Display name",
    memoryApiRole: "Role",
    memoryApiPrefs: "Prefs",
    memoryApiPrefsHint: "Standing preferences agents should follow (tone, tools, do-nots).",
    ...
    memoryApiTokensHint:
      "Issue a token for each client. Paste it once into mcp.json as SHOGUN_API_TOKEN. Secrets stay in Keychain.",
    memoryApiTokenNamePlaceholder: "Client name (e.g. Cursor)",
    memoryApiIssueToken: "Issue",
    memoryApiRevokeToken: "Revoke",
    memoryApiTokenIssued: "Copy this token now — it will not be shown again.",
    memoryApiNoTokens: "No tokens yet — MCP allows process-trust until you issue one.",
    quit: "Quit ShogunAI",
