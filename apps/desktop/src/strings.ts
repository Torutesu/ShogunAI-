...
export const STRINGS = {
  en: {
    ...
    meetingMore: "More",
    meetingMoreStealth: "Stealth mode",
    meetingMoreStealthHint: "Hide meeting panels for this meeting",
    meetingMoreOpacity: "Opacity",
    meetingMoreDictionary: "Dictionary",
    meetingMoreLanguage: "Language",
    meetingMoreShortcuts: "Shortcuts",
    meetingMoreMicrophone: "Microphone",
    meetingMoreSystemAudio: "System Audio",
    meetingMoreAutomatic: "Automatic",
    meetingMoreDefaultInput: "Mac default",
    meetingMoreBack: "Back",
    meetingMoreManage: "Open Settings",
    meetingPause: "Pause",
