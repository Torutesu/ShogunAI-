...
export const STRINGS = {
  en: {
    ...
    voiceEditKeyAbsent: "Not set — raw transcript only.",
    ...
    onboarding: {
      brand: "SHOGUN",
      welcomeStep: "Welcome",
      welcomeTitle: "Make room for your work.",
      welcomeLead: "SHOGUN stays close, then acts only when you ask.",
      signInTitle: "Welcome to Shogun",
      signInLead: "Your work, ready when you are.",
      signInBrowser: "Sign in via browser",
      signingIn: "Signing you in…",
      overviewStep: "Welcome",
      overviewTitle: "Welcome to Shogun",
      overviewLead: "A local-first assistant for writing, recall, and meetings. Right where you work.",
      overviewFeatures: "What Shogun can do",
      overviewRewrite: "Rewrite without leaving the app you are in.",
      overviewDictate: "Dictate directly into any text field.",
      overviewRecall: "Remember the work you choose.",
      overviewMeetings: "Turn meetings into useful notes.",
      overviewNavigation: "Onboarding navigation",
      back: "Back",
      next: "Next",
      privacyStep: "Privacy",
      privacyTitle: "Your work stays yours.",
      privacyLead: "Context begins on this Mac. You decide when anything leaves it.",
      privacyNote: "Permission checks are quiet. SHOGUN asks only after you choose Allow.",
      permissionStep: "Mac access",
      ...
      restart: "Restart SHOGUN",
      restartNeeded: "Restart required",
      restartFailed: "Restart did not begin. Keep this window open and try again.",
      waiting: "Waiting for permission",
      permissionPrivacy: "You can change this later in System Settings.",
      dragHelper: "Drag SHOGUN into {permission} settings",
      singleOptionTitle: "Find Right Option.",
      singleOptionCustomTitle: "Use {shortcut}.",
      singleOptionDetail: "Tap Right Option once to prepare a draft where your cursor is.",
      singleOptionCustom: "Use {shortcut} once to prepare a draft where your cursor is.",
      doubleOptionTitle: "Make a rough note clean.",
      doubleOptionCustomTitle: "Use {shortcut} twice.",
      doubleOptionDetail: "Select this sample, then double-tap Right Option to start Scribe.",
      doubleOptionCustom: "Select this sample, then use {shortcut} twice to start Scribe.",
      dictationTitle: "Speak into the field.",
      dictationCustomTitle: "Hold {shortcut}.",
      dictationDetail: "Hold your current dictation shortcut, speak, then release.",
      dictationCustom: "Hold {shortcut}, speak, then release.",
      shortcutLabel: "Current shortcut",
      rightOptionKey: "Right Option",
      emailField: "Sample email",
      sampleEmail: "hi team, can we move our review to friday morning? i can share notes after",
      dictationField: "Dictation practice field",
      dictationPlaceholder: "Your dictated words appear here after native confirmation.",
      practiceWaiting: "Waiting for native shortcut confirmation.",
      dictationWaiting: "Waiting for native dictation result. Copied or failed text stays a retry.",
      practiceRetry: "That attempt did not land in this field. Try again.",
      restoreRightOption: "Restore Right Option",
      restoreDictation: "Restore dictation shortcut",
      enableDictation: "Enable dictation",
      tryAgain: "Try again",
      planTitle: "Choose a starting point.",
      planLead: "Keep this choice flexible. Billing stays separate from setup.",
      standard: "Standard",
      pro: "Pro",
      connectTitle: "Connect what helps.",
      connectLead: "Connections are optional. Add them now or later.",
      gateTitle: "Setup is ready.",
      gateLead: "Open the gate when you are ready to begin.",
      ...
      legacyPrivacyNote: "Status checks never prompt. SHOGUN asks only after you click Allow.",
      ...
      legacyWaiting: "Waiting for permission…",
      checking: "Checking…",
