...
const jaFeatures: readonly MarketingDetail[] = [
  {
    ...
    highlights: [
      ...
      { title: '画像ではなく文脈', body: '大量のスクリーンショットを見返す方式ではなく、検索・再利用できる構造化された仕事の文脈を中心に設計しています。' },
    ...
    faq: [
      ['ShogunAIはスクリーンショットを保存しますか？', 'いいえ。スクリーンショットの保管庫ではなく、検索可能で構造化された仕事の文脈をつくる設計です。'],
...
const esFeatures: readonly MarketingDetail[] = [
  {
    ...
    faq: [['¿ShogunAI guarda capturas de pantalla?', 'No. Está diseñado para crear contexto estructurado y consultable, no un archivo de capturas.'], ['¿Dónde se guarda la memoria?', 'La memoria es local-first y permanece en tu Mac por defecto. Los servicios opcionales solo reciben el contexto necesario para una acción autorizada.'], ['¿Tengo que tomar notas manualmente?', 'No. La captura pasiva reduce el trabajo manual y permite añadir o eliminar contexto de forma intencional.']],
  },
  {
