...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  // The tagline is deliberately the same on every locale; only the description is localized.
  ...
  return {
    ...
    openGraph: { locale: copy.og, url: `${siteConfig.url}/${locale}`, title, description: copy.description },
    twitter: { card: 'summary_large_image', title, description: copy.description, images: ['/og-image.png'] },
  };
}
